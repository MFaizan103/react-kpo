...
const Footer = () => {
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
          <div className="flex-1">
            <Link
              to="/Home"
              className="text-white text-lg font-bold flex items-center mb-4"
            >
              <img
                className="pr-2"
                src="/logo.png"
                width="52px"
                alt="Karachi Police Office"
              />
            ...
            <p className="text-left md:text-left">Contact: +92 213 569369</p>
            <p className="text-left md:text-left">
      ...
      <div className="py-4 mt-8" style={{ backgroundColor: "#0F0030" }}>
